...
const { isLinux, getReport } = __webpack_require__(5760);
const { LDD_PATH, SELF_PATH, readFile, readFileSync } = __webpack_require__(4322);
const { interpreterPath } = __webpack_require__(9880);
...
var isArrayish = __webpack_require__(6195);
...
const is = __webpack_require__(5424);
...
const color = __webpack_require__(2520);
const is = __webpack_require__(5424);
...
const Sharp = __webpack_require__(4806);
__webpack_require__(1158)(Sharp);
__webpack_require__(9212)(Sharp);
__webpack_require__(6317)(Sharp);
__webpack_require__(6491)(Sharp);
__webpack_require__(9684)(Sharp);
__webpack_require__(3897)(Sharp);
__webpack_require__(2837)(Sharp);
__webpack_require__(8398)(Sharp);
...
const color = __webpack_require__(2520);
const is = __webpack_require__(5424);
const sharp = __webpack_require__(9814);
...
const { spawnSync } = __webpack_require__(1421);
const { createHash } = __webpack_require__(5217);
const semverCoerce = __webpack_require__(6170);
const semverGreaterThanOrEqualTo = __webpack_require__(4089);
const semverSatisfies = __webpack_require__(7638);
const detectLibc = __webpack_require__(4647);

const { config, engines, optionalDependencies } = __webpack_require__(7816);
...
const buildSharpLibvipsIncludeDir = () => {
  try {
    return __webpack_require__(1650)(`./sharp-libvips-dev-${buildPlatformArch()}/include`);
  } catch {
    try {
...
const buildSharpLibvipsLibDir = () => {
  try {
    return __webpack_require__(5035)(`./sharp-libvips-dev-${buildPlatformArch()}/lib`);
  } catch {
    try {
      return __webpack_require__(3527)(`./sharp-libvips-${buildPlatformArch()}/lib`);
    } catch {}
  }
  /* istanbul ignore next */
  return '';
...
const { familySync, versionSync } = __webpack_require__(4647);

const { runtimePlatformArch, isUnsupportedNodeRuntime, prebuiltPlatforms, minimumLibvipsVersion } = __webpack_require__(1313);
...
for (const path of paths) {
  try {
    sharp = __webpack_require__(8678)(path);
    break;
  } catch (err) {
    /* istanbul ignore next */
    errors.push(err);
...
if (sharp) {
  ...
  if (isLinux && /(symbol not found|CXXABI_)/i.test(messages)) {
    try {
      const { config } = __webpack_require__(7418)(`./sharp-libvips-${runtimePlatform}/package`);
...
const events = __webpack_require__(8474);
const detectLibc = __webpack_require__(4647);

const is = __webpack_require__(5424);
const { runtimePlatformArch } = __webpack_require__(1313);
const sharp = __webpack_require__(9814);
...
if (!libvipsVersion.isGlobal) {
  if (!libvipsVersion.isWasm) {
    try {
      versions = __webpack_require__(7695)(`./sharp-${runtimePlatform}/versions`);
    } catch (_) {
      try {
        versions = __webpack_require__(8503)(`./sharp-libvips-${runtimePlatform}/versions`);
      } catch (_) {}
    }
  } else {
    try {
...
versions.sharp = (__webpack_require__(7816).version);
...
if (detectLibc.familySync() === detectLibc.GLIBC && !sharp._isUsingJemalloc()) {
  ...
  sharp.concurrency((__webpack_require__(8161).availableParallelism)());
}
